...
func FuzzParseDAC(f *testing.F) {
	...
	// Inconsistent RESP_SIZE / PROTOCOLVERSION, which the parser must reject,
	// a longer-than-expected reply, and an empty instance name.
	f.Add([]byte{0x05, 0x00, 0x00, 0x00, 0x9A, 0x05}, "SQLEXPRESS")
	f.Add([]byte{0x05, 0xFF, 0xFF, 0x01, 0x9A, 0x05}, "SQLEXPRESS")
	f.Add([]byte{0x05, 0x06, 0x00, 0x00, 0x9A, 0x05}, "SQLEXPRESS")
