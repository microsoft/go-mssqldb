...
// Azure SQL Database
connStr := "sqlserver://user:password@server.database.windows.net?database=mydb"
...
db, err := sql.Open(azuread.DriverName, 
    "sqlserver://server.database.windows.net?database=mydb&fedauth=ActiveDirectoryDefault")
```
