	...
	mock := NewMockTransportDialer(
		[]string{
			"  12 01 00 2f 00 00 01 00  00 00 1a 00 06 01 00 20\n" +
				...
				"01 ff 00 00 14 00 00 00  00 00 00 00 00 00 00\n",
			"   10 01 00 c6 00 00 01 00  be 00 00 00 04 00 00 74\n" +
				"00 10 00 00 00 00 14 00  00 00 00 00 00 00 00 00\n" +
	...
	mock := NewMockTransportDialer(
		[]string{
			"  12 01 00 35 00 00 01 00  00 00 1F 00 06 01 00 25\n" +
				...
				"01 06 00 2c 00 01 ff 00  00 14 00 00 00 00 00 00\n" +
				"00 00 00 00 01\n",
			"    10 01 00 CF 00 00 01 00  C7 00 00 00 04 00 00 74\n" +
				"00 10 00 00 00 00 14 00  00 00 00 00 00 00 00 00\n" +
	...
	mock := NewMockTransportDialer(
		[]string{
			"  12 01 00 35 00 00 01 00  00 00 1F 00 06 01 00 25\n" +
				...
				"01 06 00 2C 00 01 ff 00  00 14 00 00 00 00 00 00\n" +
				"00 00 00 00 01\n",
			"    10 01 00 BE 00 00 01 00  b6 00 00 00 04 00 00 74\n" +
				"00 10 00 00 00 00 14 00  00 00 00 00 00 00 00 00\n" +
				"A0 02 00 10 00 00 00 00  00 00 00 00 5e 00 09 00\n" +
				"70 00 00 00 70 00 00 00  70 00 0a 00 84 00 09 00\n" +
				"AA 00 04 00 96 00 0A 00  AA 00 00 00 AA 00 00 00\n" +
